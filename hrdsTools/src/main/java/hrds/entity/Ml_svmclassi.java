...
public class Ml_svmclassi extends TableEntity
{
	...
	*/
	...
	private BigDecimal regparam; //正则化参数
	...
	public void setRegparam(String regparam){
		if(!fd.ng.core.utils.StringUtil.isEmpty(regparam)){
			this.regparam=new BigDecimal(regparam);
		}
	}
	/** 取得：创建日期 */
