...
public class EdwTableJoinTemp extends TableEntity {
	...
	public void setTabname(String tabname) {
		if(tabname==null) throw new BusinessException("Entity : EdwTableJoinTemp.tabname must not null!");
		this.tabname = tabname;
	}

	public String getTabalias() { return tabalias; }
	public void setTabalias(String tabalias) {
		if(tabalias==null) addNullValueField("tabalias");
	...
	public void setSt_dt(String st_dt) {
		if(st_dt==null) throw new BusinessException("Entity : EdwTableJoinTemp.st_dt must not null!");
		this.st_dt = st_dt;
	}

	public String getSt_time() { return st_time; }
	public void setSt_time(String st_time) {
		if(st_time==null) throw new BusinessException("Entity : EdwTableJoinTemp.st_time must not null!");
	...
	public void setJobcode(String jobcode) {
		if(jobcode==null) throw new BusinessException("Entity : EdwTableJoinTemp.jobcode must not null!");
	...
	public void setSerial_num(Integer serial_num) {
		if(serial_num==null) throw new BusinessException("Entity : EdwTableJoinTemp.serial_num must not null!");
