...
public class CleanParameter extends TableEntity {
	...
	public void setDatabase_id(BigDecimal database_id) {
		if(database_id==null) throw new BusinessException("Entity : CleanParameter.database_id must not null!");
	...
	public void setC_id(BigDecimal c_id) {
		if(c_id==null) throw new BusinessException("Entity : CleanParameter.c_id must not null!");
		this.c_id = c_id;
	}
	...
	public void setClean_type(String clean_type) {
		if(clean_type==null) throw new BusinessException("Entity : CleanParameter.clean_type must not null!");
