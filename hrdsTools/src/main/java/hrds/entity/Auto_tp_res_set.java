...
public class Auto_tp_res_set extends TableEntity
{
	...
	*/
	...
	private String is_dese; //是否脱敏
	private String res_show_column; //结果显示字段
	private Long template_id; //模板ID
	private String column_type; //字段类型
	private String source_table_name; //字段来源表名
