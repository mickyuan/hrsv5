...
public class Ml_nbmodel extends TableEntity
{
	...
	*/
	...
	private BigDecimal lambda; //平滑参数
	private String nbmodel_type; //朴素贝叶斯模型
	...
	public void setLambda(String lambda){
		if(!fd.ng.core.utils.StringUtil.isEmpty(lambda)){
			this.lambda=new BigDecimal(lambda);
		}
	}
	/** 取得：朴素贝叶斯模型 */
	public String getNbmodel_type(){
		return nbmodel_type;
	}
	/** 设置：朴素贝叶斯模型 */
