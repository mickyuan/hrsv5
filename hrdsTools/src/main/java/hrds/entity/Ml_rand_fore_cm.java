...
public class Ml_rand_fore_cm extends TableEntity
{
	...
	*/
	...
	private Long tree_num; //树的个数
	private Long rnum_seed; //随机种子
	private Long tree_max_depth; //树的最大深度
	private String create_date; //创建日期
	private String create_time; //创建时间
	private String remark; //备注
	private String model_runstate; //模型运行状态
	private String nodeimpmeamet; //节点不纯度衡量方法
	...
	/** 取得：树的个数 */
	public Long getTree_num(){
		return tree_num;
	}
	/** 设置：树的个数 */
	public void setTree_num(Long tree_num){
		this.tree_num=tree_num;
	}
	/** 设置：树的个数 */
	public void setTree_num(String tree_num){
		if(!fd.ng.core.utils.StringUtil.isEmpty(tree_num)){
			this.tree_num=new Long(tree_num);
		}
	}
	/** 取得：随机种子 */
	public Long getRnum_seed(){
		return rnum_seed;
	}
	/** 设置：随机种子 */
	public void setRnum_seed(Long rnum_seed){
		this.rnum_seed=rnum_seed;
	}
	/** 设置：随机种子 */
	public void setRnum_seed(String rnum_seed){
		if(!fd.ng.core.utils.StringUtil.isEmpty(rnum_seed)){
			this.rnum_seed=new Long(rnum_seed);
		}
	}
	/** 取得：树的最大深度 */
