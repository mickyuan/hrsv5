...
public class TableStorageInfo extends TableEntity {
	...
	public void setIs_fullindex(String is_fullindex) {
		if(is_fullindex==null) throw new BusinessException("Entity : TableStorageInfo.is_fullindex must not null!");
		this.is_fullindex = is_fullindex;
	}

	public BigDecimal getStorage_id() { return storage_id; }
	public void setStorage_id(BigDecimal storage_id) {
		if(storage_id==null) throw new BusinessException("Entity : TableStorageInfo.storage_id must not null!");
		this.storage_id = storage_id;
	}

	public String getIs_mpp() { return is_mpp; }
	public void setIs_mpp(String is_mpp) {
		if(is_mpp==null) throw new BusinessException("Entity : TableStorageInfo.is_mpp must not null!");
		this.is_mpp = is_mpp;
	}

	public String getIs_compression() { return is_compression; }
	public void setIs_compression(String is_compression) {
		if(is_compression==null) throw new BusinessException("Entity : TableStorageInfo.is_compression must not null!");
	...
	public void setIs_solr_hbase(String is_solr_hbase) {
		if(is_solr_hbase==null) throw new BusinessException("Entity : TableStorageInfo.is_solr_hbase must not null!");
		this.is_solr_hbase = is_solr_hbase;
	}

	public String getFile_format() { return file_format; }
	public void setFile_format(String file_format) {
		if(file_format==null) throw new BusinessException("Entity : TableStorageInfo.file_format must not null!");
		this.file_format = file_format;
	}

	public String getIs_cbd() { return is_cbd; }
	public void setIs_cbd(String is_cbd) {
		if(is_cbd==null) throw new BusinessException("Entity : TableStorageInfo.is_cbd must not null!");
		this.is_cbd = is_cbd;
	}

	public String getIs_into_hbase() { return is_into_hbase; }
	public void setIs_into_hbase(String is_into_hbase) {
		if(is_into_hbase==null) throw new BusinessException("Entity : TableStorageInfo.is_into_hbase must not null!");
	...
	public void setIs_into_hive(String is_into_hive) {
		if(is_into_hive==null) throw new BusinessException("Entity : TableStorageInfo.is_into_hive must not null!");
		this.is_into_hive = is_into_hive;
	}

	public String getTable_type() { return table_type; }
	public void setTable_type(String table_type) {
		if(table_type==null) throw new BusinessException("Entity : TableStorageInfo.table_type must not null!");
