...
public class SourceRelationDep extends TableEntity {
	...
	public void setDep_id(BigDecimal dep_id) {
		if(dep_id==null) throw new BusinessException("Entity : SourceRelationDep.dep_id must not null!");
		this.dep_id = dep_id;
	}

	public BigDecimal getSource_id() { return source_id; }
	public void setSource_id(BigDecimal source_id) {
		if(source_id==null) throw new BusinessException("Entity : SourceRelationDep.source_id must not null!");
