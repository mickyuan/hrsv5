...
public class EtlJobHandHis extends TableEntity {
	...
	public void setEvent_id(String event_id) {
		if(event_id==null) throw new BusinessException("Entity : EtlJobHandHis.event_id must not null!");
		this.event_id = event_id;
	}

	public String getEtl_sys_cd() { return etl_sys_cd; }
	public void setEtl_sys_cd(String etl_sys_cd) {
		if(etl_sys_cd==null) throw new BusinessException("Entity : EtlJobHandHis.etl_sys_cd must not null!");
	...
	public void setEtl_job(String etl_job) {
		if(etl_job==null) throw new BusinessException("Entity : EtlJobHandHis.etl_job must not null!");
