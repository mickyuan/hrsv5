...
public class EtlJobDispHis extends TableEntity {
	...
	public void setPro_type(String pro_type) {
		if(pro_type==null) addNullValueField("pro_type");
	...
	public void setSub_sys_cd(String sub_sys_cd) {
		if(sub_sys_cd==null) throw new BusinessException("Entity : EtlJobDispHis.sub_sys_cd must not null!");
		this.sub_sys_cd = sub_sys_cd;
	}

	public String getEtl_sys_cd() { return etl_sys_cd; }
	public void setEtl_sys_cd(String etl_sys_cd) {
		if(etl_sys_cd==null) throw new BusinessException("Entity : EtlJobDispHis.etl_sys_cd must not null!");
	...
	public void setCurr_bath_date(String curr_bath_date) {
		if(curr_bath_date==null) throw new BusinessException("Entity : EtlJobDispHis.curr_bath_date must not null!");
	...
	public void setEtl_job(String etl_job) {
		if(etl_job==null) throw new BusinessException("Entity : EtlJobDispHis.etl_job must not null!");
