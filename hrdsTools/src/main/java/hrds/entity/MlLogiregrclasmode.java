...
public class MlLogiregrclasmode extends TableEntity {
	...
	public void setModel_runstate(String model_runstate) {
		if(model_runstate==null) throw new BusinessException("Entity : MlLogiregrclasmode.model_runstate must not null!");
		this.model_runstate = model_runstate;
	}

	public String getModel_name() { return model_name; }
	public void setModel_name(String model_name) {
		if(model_name==null) throw new BusinessException("Entity : MlLogiregrclasmode.model_name must not null!");
	...
	public void setMinibatchfraction(BigDecimal minibatchfraction) {
		if(minibatchfraction==null) throw new BusinessException("Entity : MlLogiregrclasmode.minibatchfraction must not null!");
		this.minibatchfraction = minibatchfraction;
	}

	public String getCreate_time() { return create_time; }
	public void setCreate_time(String create_time) {
		if(create_time==null) throw new BusinessException("Entity : MlLogiregrclasmode.create_time must not null!");
		this.create_time = create_time;
	}

	public String getDv_column() { return dv_column; }
	public void setDv_column(String dv_column) {
		if(dv_column==null) throw new BusinessException("Entity : MlLogiregrclasmode.dv_column must not null!");
	...
	public void setNumiterations(BigDecimal numiterations) {
		if(numiterations==null) throw new BusinessException("Entity : MlLogiregrclasmode.numiterations must not null!");
	...
	public void setDtable_info_id(BigDecimal dtable_info_id) {
		if(dtable_info_id==null) throw new BusinessException("Entity : MlLogiregrclasmode.dtable_info_id must not null!");
	...
	public void setModel_id(BigDecimal model_id) {
		if(model_id==null) throw new BusinessException("Entity : MlLogiregrclasmode.model_id must not null!");
		this.model_id = model_id;
	}

	public String getCreate_date() { return create_date; }
	public void setCreate_date(String create_date) {
		if(create_date==null) throw new BusinessException("Entity : MlLogiregrclasmode.create_date must not null!");
	...
	public void setStepsize(BigDecimal stepsize) {
		if(stepsize==null) throw new BusinessException("Entity : MlLogiregrclasmode.stepsize must not null!");
