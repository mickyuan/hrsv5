...
public class DataSource extends TableEntity {
	...
	public void setSource_remark(String source_remark) {
		if(source_remark==null) addNullValueField("source_remark");
		this.source_remark = source_remark;
	}

	public String getCreate_time() { return create_time; }
	public void setCreate_time(String create_time) {
		if(create_time==null) throw new BusinessException("Entity : DataSource.create_time must not null!");
		this.create_time = create_time;
	}

	public BigDecimal getUser_id() { return user_id; }
	public void setUser_id(BigDecimal user_id) {
		if(user_id==null) throw new BusinessException("Entity : DataSource.user_id must not null!");
	...
	public void setSource_id(BigDecimal source_id) {
		if(source_id==null) throw new BusinessException("Entity : DataSource.source_id must not null!");
		this.source_id = source_id;
	}

	public String getDatasource_number() { return datasource_number; }
	public void setDatasource_number(String datasource_number) {
		if(datasource_number==null) addNullValueField("datasource_number");
		this.datasource_number = datasource_number;
	}

	public String getCreate_date() { return create_date; }
	public void setCreate_date(String create_date) {
		if(create_date==null) throw new BusinessException("Entity : DataSource.create_date must not null!");
