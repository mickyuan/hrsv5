...
public class EtlJob extends TableEntity {
	...
	public void setSub_sys_cd(String sub_sys_cd) {
		if(sub_sys_cd==null) throw new BusinessException("Entity : EtlJob.sub_sys_cd must not null!");
		this.sub_sys_cd = sub_sys_cd;
	}

	public String getEtl_sys_cd() { return etl_sys_cd; }
	public void setEtl_sys_cd(String etl_sys_cd) {
		if(etl_sys_cd==null) throw new BusinessException("Entity : EtlJob.etl_sys_cd must not null!");
	...
	public void setEtl_job(String etl_job) {
		if(etl_job==null) throw new BusinessException("Entity : EtlJob.etl_job must not null!");
