...
public class Edw_mapping_temp extends TableEntity
{
	...
	*/
	...
	private Long tmp_id; //临时表id
	private String is_add; //是否新增
	...
	public void setTmp_id(String tmp_id){
		if(!fd.ng.core.utils.StringUtil.isEmpty(tmp_id)){
			this.tmp_id=new Long(tmp_id);
		}
	}
	/** 取得：是否新增 */
