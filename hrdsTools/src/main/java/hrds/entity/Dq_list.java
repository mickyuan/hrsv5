...
public class Dq_list extends TableEntity
{
	...
	*/
	...
	private String load_strategy; //加载策略
	private String group_seq; //分组序号
	private String target_tab; //目标表名
	private String target_key_fields; //目标表关键字段
	private String opposite_tab; //比对表名
	private String opposite_key_fields; //比对表关键字段
	private String range_min_val; //范围区间的最小值
	private String range_max_val; //范围区间的最大值
	private String list_vals; //清单值域
	private String check_limit_condition; //检查范围限定条件
	private String specify_sql; //指定SQL
	private String err_data_sql; //异常数据SQL
	private String index_desc1; //检测指标1含义
	private String index_desc2; //检测指标2含义
	private String index_desc3; //检测指标3含义
	private String flags; //标志域
	...
	private String mail_receive; //接收邮箱
