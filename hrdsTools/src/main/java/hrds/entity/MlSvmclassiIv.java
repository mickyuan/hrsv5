...
public class MlSvmclassiIv extends TableEntity {
	...
	public void setIv_id(BigDecimal iv_id) {
		if(iv_id==null) throw new BusinessException("Entity : MlSvmclassiIv.iv_id must not null!");
		this.iv_id = iv_id;
	}

	public String getIv_column() { return iv_column; }
	public void setIv_column(String iv_column) {
		if(iv_column==null) throw new BusinessException("Entity : MlSvmclassiIv.iv_column must not null!");
		this.iv_column = iv_column;
	}

	public BigDecimal getModel_id() { return model_id; }
	public void setModel_id(BigDecimal model_id) {
		if(model_id==null) throw new BusinessException("Entity : MlSvmclassiIv.model_id must not null!");
