...
public class SourceFileDetailed extends TableEntity {
	...
	public String getSfd_id() { return sfd_id; }
	public void setSfd_id(String sfd_id) {
		if(sfd_id==null) throw new BusinessException("Entity : SourceFileDetailed.sfd_id must not null!");
		this.sfd_id = sfd_id;
	}

	public BigDecimal getCollect_set_id() { return collect_set_id; }
	public void setCollect_set_id(BigDecimal collect_set_id) {
		if(collect_set_id==null) throw new BusinessException("Entity : SourceFileDetailed.collect_set_id must not null!");
	...
	public void setStorage_date(String storage_date) {
		if(storage_date==null) throw new BusinessException("Entity : SourceFileDetailed.storage_date must not null!");
		this.storage_date = storage_date;
	}

	public BigDecimal getAgent_id() { return agent_id; }
	public void setAgent_id(BigDecimal agent_id) {
		if(agent_id==null) throw new BusinessException("Entity : SourceFileDetailed.agent_id must not null!");
	...
	public void setOriginal_update_date(String original_update_date) {
		if(original_update_date==null) throw new BusinessException("Entity : SourceFileDetailed.original_update_date must not null!");
	...
	public void setFile_size(BigDecimal file_size) {
		if(file_size==null) throw new BusinessException("Entity : SourceFileDetailed.file_size must not null!");
	...
	public void setStorage_time(String storage_time) {
		if(storage_time==null) throw new BusinessException("Entity : SourceFileDetailed.storage_time must not null!");
	...
	public void setOriginal_update_time(String original_update_time) {
		if(original_update_time==null) throw new BusinessException("Entity : SourceFileDetailed.original_update_time must not null!");
		this.original_update_time = original_update_time;
	}

	public String getFile_type() { return file_type; }
	public void setFile_type(String file_type) {
		if(file_type==null) throw new BusinessException("Entity : SourceFileDetailed.file_type must not null!");
		this.file_type = file_type;
	}

	public String getFile_suffix() { return file_suffix; }
	public void setFile_suffix(String file_suffix) {
		if(file_suffix==null) throw new BusinessException("Entity : SourceFileDetailed.file_suffix must not null!");
	...
	public void setFile_id(String file_id) {
		if(file_id==null) throw new BusinessException("Entity : SourceFileDetailed.file_id must not null!");
		this.file_id = file_id;
	}

	public String getOriginal_name() { return original_name; }
	public void setOriginal_name(String original_name) {
		if(original_name==null) throw new BusinessException("Entity : SourceFileDetailed.original_name must not null!");
	...
	public String getHdfs_storage_path() { return hdfs_storage_path; }
	public void setHdfs_storage_path(String hdfs_storage_path) {
		if(hdfs_storage_path==null) addNullValueField("hdfs_storage_path");
		this.hdfs_storage_path = hdfs_storage_path;
	}

	public String getSource_path() { return source_path; }
	public void setSource_path(String source_path) {
		if(source_path==null) throw new BusinessException("Entity : SourceFileDetailed.source_path must not null!");
		this.source_path = source_path;
	}

	public BigDecimal getSource_id() { return source_id; }
	public void setSource_id(BigDecimal source_id) {
		if(source_id==null) throw new BusinessException("Entity : SourceFileDetailed.source_id must not null!");
	...
	public void setHbase_name(String hbase_name) {
		if(hbase_name==null) throw new BusinessException("Entity : SourceFileDetailed.hbase_name must not null!");
