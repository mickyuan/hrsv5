...
public class AutoCompDataSum extends TableEntity {
	...
	private BigDecimal comp_data_sum_id;
	...
	public void setCreate_time(String create_time) {
		if(create_time==null) throw new BusinessException("Entity : AutoCompDataSum.create_time must not null!");
		this.create_time = create_time;
	}

	public String getColumn_name() { return column_name; }
	public void setColumn_name(String column_name) {
		if(column_name==null) throw new BusinessException("Entity : AutoCompDataSum.column_name must not null!");
	...
	public BigDecimal getComp_data_sum_id() { return comp_data_sum_id; }
	public void setComp_data_sum_id(BigDecimal comp_data_sum_id) {
		if(comp_data_sum_id==null) throw new BusinessException("Entity : AutoCompDataSum.comp_data_sum_id must not null!");
		this.comp_data_sum_id = comp_data_sum_id;
	}

	public String getSummary_type() { return summary_type; }
	public void setSummary_type(String summary_type) {
		if(summary_type==null) throw new BusinessException("Entity : AutoCompDataSum.summary_type must not null!");
		this.summary_type = summary_type;
	}

	public String getCreate_date() { return create_date; }
	public void setCreate_date(String create_date) {
		if(create_date==null) throw new BusinessException("Entity : AutoCompDataSum.create_date must not null!");
