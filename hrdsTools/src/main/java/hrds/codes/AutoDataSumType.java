...
public enum AutoDataSumType {
	/**求和<QiuHe>  */
	QiuHe("01","求和","160","可视化数据汇总类型"),
	/**求平均<QiuPingJun>  */
	QiuPingJun("02","求平均","160","可视化数据汇总类型"),
	/**求最大值<QiuZuiDaZhi>  */
	QiuZuiDaZhi("03","求最大值","160","可视化数据汇总类型"),
	/**求最小值<QiuZuiXiaoZhi>  */
	QiuZuiXiaoZhi("04","求最小值","160","可视化数据汇总类型"),
	/**总行数<ZongHangShu>  */
	ZongHangShu("05","总行数","160","可视化数据汇总类型"),
	/**原始数据<YuanShiShuJu>  */
	YuanShiShuJu("06","原始数据","160","可视化数据汇总类型"),
	/**查看全部<ChaKanQuanBu>  */
	ChaKanQuanBu("07","查看全部","160","可视化数据汇总类型");
	...
	* @return
	*/
	public static AutoDataSumType getCodeObj(String code) {
		for (AutoDataSumType typeCode : AutoDataSumType.values()) {
			if (typeCode.getCode().equals(code)) {
				return typeCode;
			}
