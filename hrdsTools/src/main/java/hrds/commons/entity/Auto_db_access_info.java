...
public class Auto_db_access_info extends TableEntity
{
	...
	*/
	...
	private String db_ip; //数据库服务ip
	private String db_user; //数据库访问用户名
	private String db_password; //数据库访问密码
	private String db_port; //数据服访问端口
	private String jdbcurl; //jdbcurl
	private Long access_info_id; //数据库访问信息表id
