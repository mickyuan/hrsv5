	...
	public void login() {
		...
		String userEmptyMsg =
				new HttpClient()
						...
						.getBodyString();
		ActionResult userEmpty = JsonUtil.toObjectSafety(userEmptyMsg, ActionResult.class)
		...
		String pwdErrorMsg =
				new HttpClient()
						...
						.post(getActionUrl("login"))
						.getBodyString();
		ActionResult pwdError = JsonUtil.toObjectSafety(pwdErrorMsg, ActionResult.class)
				.orElseThrow(() -> new BusinessException("登录失败"));
		...
		String userErrorMsg =
				new HttpClient()
						...
						.post(getActionUrl("login"))
						.getBodyString();
		ActionResult userError = JsonUtil.toObjectSafety(userErrorMsg, ActionResult.class)
				.orElseThrow(() -> new BusinessException("登录失败"));
		...
		String userPwdErrorMsg =
				new HttpClient()
						...
						.post(getActionUrl("login"))
						.getBodyString();
		ActionResult userPwdError = JsonUtil.toObjectSafety(userPwdErrorMsg, ActionResult.class)
				.orElseThrow(() -> new BusinessException("登录失败"));
		;
		...
		try (DatabaseWrapper db = new DatabaseWrapper()) {
			...
			String deptErrorMsg =
					new HttpClient()
							...
							.post(getActionUrl("login"))
							.getBodyString();
			ActionResult deptError = JsonUtil.toObjectSafety(deptErrorMsg, ActionResult.class)
					.orElseThrow(() -> new BusinessException("登录失败"));
			...
			String successRequestMsg =
					new HttpClient()
							...
							.post(getActionUrl("login"))
							.getBodyString();
			ActionResult successMsg = JsonUtil.toObjectSafety(successRequestMsg, ActionResult.class)
					.orElseThrow(() -> new BusinessException("登录失败"));
