...
@DocClass(desc = "接口信息测试类", author = "dhw", createdate = "2020/3/30 14:50")
public class InterfaceInfoActionTest extends WebBaseTestCase {
	...
	// 用户ID
	private static final long USER_ID = 8885L;
	// 部门ID
	private static final long DEP_ID = 8881L;
