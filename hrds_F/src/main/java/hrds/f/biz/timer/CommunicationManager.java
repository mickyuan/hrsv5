...
public class CommunicationManager extends TimerTask {
  ...
  /** 建立HttpClient请求工具类 */
  //  private static final AgentMonitorUtil monitorUtil = new AgentMonitorUtil();
  ...
  public List<Map<String, Object>> getAgent_info(DatabaseWrapper db) {
  ...
  public static void updateAgentStatus(long agent_id, DatabaseWrapper db, String agent_status) {
    ...
    //    } else { // 采集Agent
    db.execute("UPDATE agent_info SET agent_status = ? WHERE agent_id = ?", agent_status, agent_id);
  }
}
