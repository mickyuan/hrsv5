...
public class FileConversionThread implements Callable<String> {
	...
	//打印日志
	private static final Log log = LogFactory.getLog(FileConversionThread.class);
	...
	@Override
	public String call() {
		return FileParserFactory.getFileParserImpl(tableBean, collectTableBean, readFile).parserFile();
	}
