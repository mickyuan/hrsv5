...
public class UnstructuredFileCollectAction extends BaseAction {
	 ...
	 * 3、返回到前端
	 *
	 * @param file_collect_set 含义：文件系统设置表对象，接收页面传过来的参数Agent_id和fcs_id(文件系统采集ID)
	 *                         取值范围：不可空
...
//		Map<String, Object> data = (HashMap<String, Object>) ar.getData();
	...
	/**
	 * description: 保存或更新非结构化文件采集页面信息到文件系统设置表对象，同时返回文件系统采集表id <br>
	 * date: 2019/9/12 11:07 <br>
	 * author: zxz <br>
	 * version: 5.0 <br>
	 * 步骤：
	 ...
	 * 3、返回到前端
	 *
	 * @param file_collect_set 含义：文件系统设置表对象
	 *                         取值范围：不可为空
	 * @param is_add           含义：是否新增非结构化采集
	 *                         取值范围：不可为空
	 * @return long
	 * 含义：文件系统采集表主键、fcs_id
	 * 取值范围：不会为空
	...
	/**
	 * description: 根据文件系统设置表id获取源文件设置表的合集<br>
	 * date: 2019/9/12 15:17 <br>
	 * author: zxz <br>
	 * version: 5.0 <br>
	 * 步骤：
	...
	/**
	 * description: 选择文件夹 <br>
	 * date: 2019/9/16 14:08 <br>
	 * author: zxz <br>
	 * version: 5.0 <br>
	 * 步骤：
	 * 1、根据前端传过来的agent_id获取agent的ip和端口等基本信息
	 ...
	 * 3、返回到前端
	 *
	 * @param agent_id 含义：文件采集Agent的id
	 *                 取值范围：不能为空
	 * @param path     含义：选择Agent服务器所在路径下的文件夹，为空则返回根目录下的所有文件夹
	 *                 取值范围：可为空
	 * @return com.alibaba.fastjson.JSONObject
	 * 含义：路径下文件夹的集合和服务器操作系统的名称
	 * 取值范围：可为空
	 */
	public JSONObject selectPath(String agent_id, String path) {
	...
	/**
	 * description: 将页面选择的需要采集的源文件路径保存到数据库 <br>
	 * date: 2019/9/12 14:57 <br>
	 * author: zxz <br>
	 * version: 5.0 <br>
	 * 步骤：
	 ...
	 * 3、更新文件系统设置表
	 *
	 * @param file_sources 含义：源文件设置表的集合，一条或多条
	 *                     取值范围：不能为空
	 * @return void
	 */
