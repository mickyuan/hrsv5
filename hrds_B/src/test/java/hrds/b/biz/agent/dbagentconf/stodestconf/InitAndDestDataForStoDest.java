...
@DocClass(desc = "为StoDestStepConfActionTest初始化和销毁数据", author = "WangZhengcheng")
/*
 * 由于构造测试数据就有较多代码，所以将这部分代码迁移出来，StoDestStepConfActionTest中只保存对被测方法的测试用例
 * */
public class InitAndDestDataForStoDest {
	...
	public static void after(){
		try (DatabaseWrapper db = new DatabaseWrapper()) {
			...
			//20、删除data_store_layer_added表数据
