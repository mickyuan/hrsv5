...
public class TaskManager {
	 ...
	 *
	 * @param etlJobCur 含义：表示一个已登记，并且需要执行的作业。
	 *                  取值范围：不能为null。
	 * @param hasHandle 含义：标识一个需要执行的作业，是否是通过干预途径而来的。
	 *                  取值范围：true/false。
	 * @author Tiger.Wang
	 * @date 2019/10/25
	 */
	 ...
	 * 4、以结束标识推送该作业到redis。
	 *
	 * @param etlJobCur 含义：表示一个执行结束的作业。
	 *                  取值范围：不能为null。
	 * @author Tiger.Wang
	 * @date 2019/10/25
	 */
