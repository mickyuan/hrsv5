package hrds.commons.utils.datastorage.redisconf;
...
public class RedisParam {
	...
	public static Map<String, Object> getRedisParam() {
		...
		Map<String, String> map = setRedisParam("", "");
		redisMap.put("redis", map);
		return redisMap;
	}

	public static Map<String, String> setRedisParam(String redis_ip, String redis_port) {
