...
public class Source_file_detailed extends TableEntity
{
	...
	*/
	...
	@ApiBean(name ="hbase_name",value="HBase对应表名",dataType = String.class,required = true)
	...
	@ApiBean(name ="hdfs_storage_path",value="hdfs储路径",dataType = String.class,required = false)
	...
	@ApiBean(name ="sfd_id",value="源文件属性清册ID",dataType = String.class,required = true)
	private String sfd_id; //源文件属性清册ID
	@ApiBean(name ="source_path",value="文件路径",dataType = String.class,required = true)
