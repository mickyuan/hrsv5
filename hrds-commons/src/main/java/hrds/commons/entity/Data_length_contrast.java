 ...
 * 存储层数据类型长度对照表
 */
@Table(tableName = "data_length_contrast")
public class Data_length_contrast extends ProjectTableEntity
{
	private static final long serialVersionUID = 321566870187324L;
	private transient static final Set<String> __PrimaryKeys;
	public static final String TableName = "data_length_contrast";
	/**
	* 检查给定的名字，是否为主键中的字段
	...
	*/
	...
	private Long dlc_id;
	@DocBean(name ="dlc_name",value="对照类型名称:",dataType = String.class,required = true)
