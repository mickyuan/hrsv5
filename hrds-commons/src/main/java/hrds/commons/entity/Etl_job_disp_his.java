...
public class Etl_job_disp_his extends TableEntity
{
	...
	*/
	...
	@ApiBean(name ="curr_bath_date",value="当前批量日期",dataType = String.class,required = true)
	...
	@ApiBean(name ="exe_frequency",value="每隔(分钟)执行	exe_frequency",dataType = Long.class,required = false)
