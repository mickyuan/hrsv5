 ...
 * 存储层数据类型对照表
 */
@Table(tableName = "data_type_contrast")
public class Data_type_contrast extends ProjectTableEntity
{
	private static final long serialVersionUID = 321566870187324L;
	private transient static final Set<String> __PrimaryKeys;
	public static final String TableName = "data_type_contrast";
	/**
	* 检查给定的名字，是否为主键中的字段
	...
	*/
	...
	@DocBean(name ="dtc_name",value="类型对照名称:",dataType = String.class,required = true)
	...
	/** 设置：类型对照名称 */
	public void setDtc_name(String dtc_name){
		this.dtc_name=dtc_name;
	}
}
