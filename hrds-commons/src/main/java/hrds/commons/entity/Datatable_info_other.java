...
public class Datatable_info_other extends TableEntity
{
	...
	*/
	...
	public void setOther_id(String other_id){
		if(!fd.ng.core.utils.StringUtil.isEmpty(other_id)){
	...
	public void setTopic_number(String topic_number){
		if(!fd.ng.core.utils.StringUtil.isEmpty(topic_number)){
	...
	public void setKafka_bk_num(String kafka_bk_num){
		if(!fd.ng.core.utils.StringUtil.isEmpty(kafka_bk_num)){
