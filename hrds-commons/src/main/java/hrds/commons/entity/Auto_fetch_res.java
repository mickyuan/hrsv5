...
public class Auto_fetch_res extends ProjectTableEntity
{
	...
	*/
	...
	@DocBean(name ="fetch_res_name",value="取数结果名称:",dataType = String.class,required = true)
	private String fetch_res_name;
	@DocBean(name ="show_num",value="显示顺序:",dataType = Integer.class,required = false)
	private Integer show_num;
	@DocBean(name ="fetch_res_id",value="取数结果ID:",dataType = Long.class,required = true)
	private Long fetch_res_id;
