...
public class Etl_job_def extends TableEntity
{
	...
	*/
	...
	@ApiBean(name ="pro_type",value="作业程序类型",dataType = String.class,required = true)
	...
	@ApiBean(name ="upd_time",value="更新日期",dataType = String.class,required = false)
