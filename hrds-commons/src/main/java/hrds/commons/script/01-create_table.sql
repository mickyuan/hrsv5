...
CHISQUARED_ID                                     BIGINT default 0 NOT NULL, --卡方检验编号
CREATE_DATE                                       CHAR(8) NULL, --创建日期
CREATE_TIME                                       CHAR(6) NULL, --创建时间
REMARK                                            VARCHAR(80) NULL, --备注
DTABLE_INFO_ID                                    BIGINT default 0 NOT NULL, --数据表信息编号
...
VARIANAL_IV_ID                                    BIGINT default 0 NOT NULL, --方差分析自变量编号
...
CHISQUATC_ID                                      BIGINT default 0 NOT NULL, --卡方检验字段编号
...
VARIANALY_DV_ID                                   BIGINT default 0 NOT NULL, --方差分析因变量编号
...
FEATFILT_ID                                       BIGINT default 0 NOT NULL, --特征过滤编号
VARIANCE_RANGE                                    DECIMAL(16,2) default 0 NULL, --方差值域
CREATE_DATE                                       CHAR(8) NOT NULL, --创建日期
CREATE_TIME                                       CHAR(6) NOT NULL, --创建时间
REMARK                                            VARCHAR(80) NULL, --备注
DTABLE_INFO_ID                                    BIGINT default 0 NULL, --数据表信息编号
...
FEATFILTC_ID                                      BIGINT default 0 NOT NULL, --特征过滤字段编号
...
FEATEXTR_ID                                       BIGINT default 0 NOT NULL, --特征抽取编号
DV_COLUMN                                         VARCHAR(64) NOT NULL, --因变量字段
...
FEATEXTR_IV_ID                                    BIGINT default 0 NOT NULL, --特征抽取自变量编号
IV_COLUMN                                         VARCHAR(64) NOT NULL, --自变量字段
FEATEXTR_ID                                       BIGINT default 0 NOT NULL, --特征抽取编号
...
DIMEREDU_ID                                       BIGINT default 0 NOT NULL, --降维编号
...
DRCOLUMN_ID                                       BIGINT default 0 NOT NULL, --降维字段编号
...
EXHAFEATS_ID                                      BIGINT default 0 NOT NULL, --穷举法特征搜索编号
DV_COLUMN                                         VARCHAR(64) NOT NULL, --因变量字段
...
EXHAFS_IV_ID                                      BIGINT default 0 NOT NULL, --穷举法特征搜索自变量编号
IV_COLUMN                                         VARCHAR(64) NOT NULL, --自变量字段
EXHAFEATS_ID                                      BIGINT default 0 NOT NULL, --穷举法特征搜索编号
...
MODEL_ID                                          BIGINT default 0 NOT NULL, --模型编号
...
IV_ID                                             BIGINT default 0 NOT NULL, --自变量编号
IV_COLUMN                                         VARCHAR(64) NOT NULL, --自变量字段
MODEL_ID                                          BIGINT default 0 NOT NULL, --模型编号
...
COND_ANAL_ID                                      BIGINT default 0 NOT NULL, --条件分析编号
SQL_ID                                            BIGINT default 0 NOT NULL, --SQL编号
...
FILTER_ID                                         BIGINT default 0 NOT NULL, --过滤编号
REPORT_ID                                         BIGINT default 0 NOT NULL, --报表编号
...
FILTERRESU_ID                                     BIGINT default 0 NOT NULL, --过滤结果编号
FILTER_ID                                         BIGINT default 0 NOT NULL, --过滤编号
COND_ANAL_ID                                      BIGINT default 0 NOT NULL, --条件分析编号
...
CATEGORY_ID                                       BIGINT default 0 NOT NULL, --模型分类id
...
TMP_ID                                            BIGINT default 0 NOT NULL, --临时表id
...
TRN_ID                                            BIGINT default 0 NOT NULL, --翻译id
...
MAPPING_JOB_ID                                    BIGINT default 0 NOT NULL, --映射作业ID
...
MODAL_PRO_ID                                      BIGINT default 0 NOT NULL, --模型工程id
...
PREDICTINFO_ID                                    BIGINT default 0 NOT NULL, --预测信息编号
...
PROJECT_ID                                        BIGINT default 0 NOT NULL, --项目编号
DTABLE_INFO_ID                                    BIGINT default 0 NOT NULL, --数据表信息编号
...
SDM_SOURCE_ID                                     BIGINT default 0 NULL, --数据源ID
...
SDM_AGENT_ID                                      BIGINT default 0 NULL, --流数据管理agent_id
...
SDM_CONSUM_ID                                     BIGINT default 0 NULL, --消费端配置id
...
SDM_RECEIVE_ID                                    BIGINT default 0 NULL, --流数据管理receive_id
...
CF_ID                                             BIGINT default 0 NOT NULL, --采集频率信息
...
RELY_JOB_ID                                       BIGINT default 0 NULL, --依赖作业id
AGENT_ID                                          BIGINT default 0 NOT NULL, --Agent_id
...
ALGORITHM_ID                                      BIGINT default 0 NOT NULL, --算法编号
...
FEATURE_ID                                        BIGINT default 0 NOT NULL, --特征编号
...
SCRIPT_ID                                         BIGINT default 0 NOT NULL, --脚本编号
...
CR_ID                                             BIGINT default 0 NOT NULL, --采集压缩信息
COLLECT_TYPE                                      CHAR(1) NOT NULL, --采集类型
...
COLUMN_ID                                         BIGINT default 0 NOT NULL, --字段编号
...
CT_ID                                             BIGINT default 0 NOT NULL, --采集传输
COLLECT_TYPE                                      CHAR(1) NOT NULL, --采集类型
...
CC_ID                                             BIGINT default 0 NOT NULL, --采集概况信息
COLLECT_TYPE                                      CHAR(1) NOT NULL, --采集类型
...
CHDFS_ID                                          BIGINT default 0 NOT NULL, --HDFS存储
COLLECT_TYPE                                      CHAR(1) NOT NULL, --采集类型
...
OTHER_ID                                          BIGINT default 0 NOT NULL, --外部存储id
...
EXPORT_ID                                         BIGINT default 0 NOT NULL, --导出表id
...
CS_ID                                             BIGINT default 0 NOT NULL, --爬虫数据源id
CREATE_ID                                         BIGINT default 0 NOT NULL, --用户ID
...
FILE_PATH                                         VARCHAR(512) NULL, --文件存储路径
USER_ID                                           BIGINT default 0 NOT NULL, --用户ID
CMSG_ID                                           BIGINT default 0 NOT NULL, --配置ID
...
CREATE_ID                                         DECIMAL(10) NOT NULL, --创建用户
PARENT_CATEGORY_ID                                BIGINT default 0 NOT NULL, --模型分类id
MODAL_PRO_ID                                      BIGINT default 0 NOT NULL, --模型工程id
...
SITE_ID                                           BIGINT default 0 NOT NULL, --站点ID
...
REMARK                                            VARCHAR(512) NULL, --备注
SDM_DES_ID                                        BIGINT default 0 NULL, --配置id
...
CP_ID                                             BIGINT default 0 NOT NULL, --自定义解析id
...
HZZY_ID                                           BIGINT default 0 NOT NULL, --后置作业表id
...
HZF_ID                                            BIGINT default 0 NOT NULL, --字段id
...
CC_ID                                             BIGINT default 0 NOT NULL, --爬虫情况ID
AGENT_ID                                          BIGINT default 0 NOT NULL, --Agent_id
START_DATE                                        CHAR(8) NULL, --开始日期
...
INFO_ID                                           BIGINT default 0 NOT NULL, --信息id
...
REMARK                                            VARCHAR(512) NULL, --备注
CREATE_ID                                         BIGINT default 0 NULL, --用户ID
...
FOLDER_ID                                         BIGINT default 0 NULL, --文件夹编号
AGENT_ID                                          BIGINT default 0 NOT NULL, --Agent_id
SOURCE_ID                                         BIGINT default 0 NOT NULL, --数据源ID
COLLECT_SET_ID                                    BIGINT default 0 NOT NULL, --数据库设置id
...
CR_ID                                             BIGINT default 0 NOT NULL, --定制爬取要求id
CREATE_ID                                         BIGINT default 0 NOT NULL, --用户ID
...
CD_ID                                             BIGINT default 0 NOT NULL, --爬取数据项表id
...
ARITHMETIC_ID                                     BIGINT default 0 NOT NULL, --图算法作业ID
...
INDEXES_ID                                        BIGINT default 0 NOT NULL, --索引ID
...
TOKENIZER_ID                                      BIGINT default 0 NOT NULL, --分词器编号
...
WORD_FILE_ID                                      BIGINT default 0 NOT NULL, --词条文件编号
TOKENIZER_ID                                      BIGINT default 0 NOT NULL, --分词器编号
...
WORD_ID                                           BIGINT default 0 NOT NULL, --词条编号
CREATE_ID                                         BIGINT default 0 NOT NULL, --用户ID
CREATE_DATE                                       CHAR(8) NOT NULL, --创建日期
CREATE_TIME                                       CHAR(6) NOT NULL, --创建时间
...
BENCHMARK_ID                                      BIGINT default 0 NOT NULL, --对标数据表id
...
SPARKD_ID                                         BIGINT default 0 NOT NULL, --sparkd_id
...
ICM_ID                                            BIGINT default 0 NOT NULL, --信息id
HBASE_NAME                                        VARCHAR(512) NOT NULL, --Hbase表名
...
SQL_ID                                            BIGINT default 0 NOT NULL, --SQL编号
FOLDER_ID                                         BIGINT default 0 NULL, --文件夹编号
REPORT_TYPE_ID                                    BIGINT default 0 NOT NULL, --报表类型编号
CONFIGURATION_ID                                  BIGINT default 0 NULL, --配置编号
...
COM_ID                                            BIGINT default 0 NOT NULL, --通讯id
...
ID                                                BIGINT default 0 NOT NULL, --目录id
SET_ID                                            BIGINT default 0 NOT NULL, --配置id
...
CONFIGURATION_ID                                  BIGINT default 0 NOT NULL, --配置编号
CREATE_ID                                         BIGINT default 0 NOT NULL, --用户ID
REPORT_TYPE_ID                                    BIGINT default 0 NOT NULL, --报表类型编号
...
INFO_ID                                           BIGINT default 0 NOT NULL, --序号
OWN_FIELD_ID                                      BIGINT default 0 NOT NULL, --字段id
...
RUN_ID                                            BIGINT default 0 NOT NULL, --运行主机ID
...
AGENT_ID                                          BIGINT default 0 NOT NULL, --作业agent
RUN_ID                                            BIGINT default 0 NULL, --运行主机ID
USER_ID                                           BIGINT default 0 NOT NULL, --用户ID
...
USER_ID                                           BIGINT default 0 NOT NULL, --用户ID
PROJECT_ID                                        BIGINT default 0 NOT NULL, --工程ID
AGENT_ID                                          BIGINT default 0 NOT NULL, --作业agent
...
JOB_ID                                            BIGINT default 0 NOT NULL, --作业Id
COMP_ID                                           VARCHAR(20) NOT NULL, --组件编号
...
REXTR_ID                                          BIGINT default 0 NOT NULL, --随机抽取编号
...
DATASPLIT_ID                                      BIGINT default 0 NOT NULL, --数据拆分编号
...
COLUMNRECO_ID                                     BIGINT default 0 NOT NULL, --字段重编码编号
VALUE_RECODE                                      VARCHAR(64) NULL, --编码前的值
NEWCOLUMN_NAME                                    VARCHAR(64) NOT NULL, --新字段名称
RECODE_ID                                         BIGINT default 0 NOT NULL, --重编码编号
...
CREATE_DATE                                       CHAR(8) NOT NULL, --创建日期
CREATE_TIME                                       CHAR(6) NOT NULL, --创建时间
RELATION_ID                                       BIGINT default 0 NOT NULL, --图表关系编号
DTABLE_INFO_ID                                    BIGINT default 0 NOT NULL, --数据表信息编号
...
TABLE_COLUMN_ID                                   BIGINT default 0 NOT NULL, --数据源表字段编号
...
STATISTICS_ID                                     BIGINT default 0 NOT NULL, --统计表编号
...
CORRANALC_ID                                      BIGINT default 0 NOT NULL, --相关性分析字段编号
CORRANAL_COLU                                     VARCHAR(64) NOT NULL, --相关性分析字段
CORRELATION_ID                                    BIGINT default 0 NOT NULL, --相关性表编号
...
DATATRAN_ID                                       BIGINT default 0 NOT NULL, --数据转换编号
...
REMARK                                            VARCHAR(80) NULL, --备注
DTABLE_INFO_ID                                    BIGINT default 0 NOT NULL, --数据表信息编号
FUNMAP_ID                                         BIGINT default 0 NOT NULL, --函数对应编码
...
DATAEXCE_ID                                       BIGINT default 0 NOT NULL, --数据异常处理编号
...
MISSVALUE_ID                                      BIGINT default 0 NOT NULL, --缺失值编号
...
CREATE_DATE                                       CHAR(8) NOT NULL, --创建日期
CREATE_TIME                                       CHAR(6) NOT NULL, --创建时间
DATAPO_INFO_ID                                    BIGINT default 0 NOT NULL, --数据预处理其它信息编号
...
STATUS_ID                                         BIGINT default 0 NOT NULL, --状态编号
PROJECT_ID                                        BIGINT default 0 NOT NULL, --项目编号
...
HEXTSCOPE_ID                                      BIGINT default 0 NOT NULL, --分层抽取范围编号
...
TRANFUNT_NUM                                      BIGINT default 0 NOT NULL, --转换函数类型编号
...
T_HYPOTEST_ID                                     BIGINT default 0 NOT NULL, --t检验编号
...
F_HYPOTEST_ID                                     BIGINT default 0 NOT NULL, --f检验编号
