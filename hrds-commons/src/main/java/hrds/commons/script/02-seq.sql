...
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000023','Z000', '/yhp', '20', '数据库配置(永洪)', 'el-icon-s-ticket');
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000024','Z001', '/yhd', '21', '报表创建(永洪)', 'el-icon-s-management');
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000025','Z002', '/yhq', '22', '报表查看(永洪)', 'el-icon-s-open');
...
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000028','K001', '/dataControl', '24', '数据管控', 'el-icon-s-finance');
...
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000030','L000', '/freeAnalysisM', '25', '自主分析管理', 'el-icon-s-claim');
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000031','L001', '/freeAnalysisU', '26', '自主分析操作', 'el-icon-s-grid');
...
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000037','K001', '/dbm', '37', '标准元管理','el-icon-s-finance');
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000038','K001','/tsb', '38', '表结构对标','el-icon-receiving');
INSERT INTO component_menu (menu_id,comp_id,menu_path,user_type,menu_name,menu_remark) VALUES ('1000000039','K001','/tdb', '39', '表数据对标','el-icon-film');
