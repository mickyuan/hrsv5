...
public class DCLDataQuery {
    ...
    public static List<Map<String, Object>> getDCLBatchTableInfos(String classify_id, User user, String isIntoHBase) {
        return getDCLBatchTableInfos(classify_id, null, user, isIntoHBase);
    }
