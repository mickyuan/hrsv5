...
public class LoginUtil {
	...
	private static final String PRNCIPAL_NAME = "hyshfAdmin";
	//	public static String PRNCIPAL_NAME = "admin@HADOOP.COM";
	private static final String confDir = System.getProperty("user.dir") + File.separator + "conf" + File.separator;
	public static String PATH_TO_KEYTAB = confDir + "user.keytab";
	public static String PATH_TO_KRB5_CONF = confDir + "krb5.conf";
	public static String PATH_TO_JAAS = confDir + "jaas.conf";
	...
	private static String PATH_TO_HBASE_SITE_XML = confDir + "hbase-site.xml";
	private static String PATH_TO_MAPRED_SITE_XML = confDir + "mapred-site.xml";
	private static String PATH_TO_YARN_SITE_XML = confDir + "yarn-site.xml";
	...
	public synchronized static void login(String userPrincipal, String userKeytabPath, String krb5ConfPath, Configuration conf) throws IOException {
		...
		logger.info("principle name : " + userPrincipal);
	...
	public static Configuration hbaseLogin(Configuration conf) throws IOException {
		...
		if( true ) {
			 ...
			 */
			LoginUtil.setJaasConf(ZOOKEEPER_DEFAULT_LOGIN_CONTEXT_NAME, PRNCIPAL_NAME, PATH_TO_KEYTAB);
